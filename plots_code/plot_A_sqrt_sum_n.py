...
for alg_id, alg in enumerate(algorithms):  
    ...
    ax.set_title('Factorization of square-root-sum tensor ($d=5$, $r=10$) with ' + alg)
...
plt.yscale("log")
plt.legend()
plt.title("Factorization of square-root-sum tensor ($d=5$, $r=10$)")
