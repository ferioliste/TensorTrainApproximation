...
data_file_name = "B_tt_random_sum_d.csv"
cols = ["d", "algorithm", "t1", "t2", "time_taken", "error"]

df = pd.read_csv(data_path_prefix + data_file_name, usecols=cols).dropna()

file_names = ["B_tt_random_sum_tt_svd_round_ratio_d", "B_tt_random_sum_tt_rsvd_round_ratio_d", "B_tt_random_sum_tt_rand_orth_round_ratio_d"]
...
file_name = "B_tt_random_sum_time_d"
...
labels = ["tt_svd_rounding", "tt_rsvd_rounding", "tt_rand_orth_rounding"]
file_name = "B_tt_random_sum_error_d"
