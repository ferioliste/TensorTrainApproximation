...
for alg_id, alg in enumerate(algorithms):  
    ...
    ax.set_title('Rounding of random-sum tensor train ($d=5$, $r=20$, $\\varepsilon=10^{-8}$) with ' + alg)
...
plt.legend()
plt.title("Rounding of random-sum tensor train ($d=5$, $r=20$, $\\varepsilon=10^{-8}$)")
